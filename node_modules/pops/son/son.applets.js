...
(function() {
	...
	X.applManager=Class('son.applets.appletManager', {
		OPTIONS: {}
	,	INIT: function(ops) {
			this.SetOptions(ops);
			this.$$applets={};
	...
	if(son.$$globalMods || son.$$global_applet) X.MakeGlobal();
}());
